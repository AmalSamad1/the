...
import 'package:the/extensions/fancy_bottom_navigation-0.3.2/lib/internal/tab_item.dart';
import 'package:the/extensions/fancy_bottom_navigation-0.3.2/lib/paint/half_clipper.dart';
import 'package:the/extensions/fancy_bottom_navigation-0.3.2/lib/paint/half_painter.dart';
    ...
    ? (Theme.of(context).brightness == Brightness.dark)
    ? Colors.white
        : Colors.white      : widget.activeIconColor;
      ...
      children: <Widget>[
        Container(
          ...
          decoration: BoxDecoration(color: barBackgroundColor,
              ...
              boxShadow: [
            BoxShadow(
                color: Colors.blue, offset: Offset(0, -1), blurRadius: 8)
          ]),
          child: Row(
